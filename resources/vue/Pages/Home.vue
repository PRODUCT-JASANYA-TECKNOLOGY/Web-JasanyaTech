    ...
    <div class="grow shrink-0">
            ...
            <div class="gradient-5 !text-white font-bold !text-[.75rem] !mb-2 !relative" style="z-index: 1;">
                <div class="container py-2 !text-center">
                    <p class="!mb-0">✨ Sandbox is part of Envato's Biggest Sale to date, be quick and grab a <a href="#"
                                                                                                                class="!text-white hover inline-flex items-center">copy
                        <i class="uil uil-arrow-right text-[0.8rem] before:content-['\e94c']"></i></a></p>
                </div>
                <!-- /.container -->
            </div>
                                ...
                                <li class="nav-item dropdown dropdown-mega">
                                    ...
                                    <ul class="dropdown-menu mega-menu mega-menu-dark mega-menu-img">
                                        <li class="mega-menu-content mega-menu-scroll">
                                            <ul class="grid grid-cols-1 xl:grid-cols-6 lg:grid-cols-6 mx-0 xl:mx-[-10px] lg:mx-[-10px] xl:!mt-[-10px] lg:!mt-[-10px] !pl-0 list-none">
                                                <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                                    <a class="dropdown-item" href="./demo1.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 src="@/assets/img/demos/mi1.jpg"
                                                                 srcset="@/assets/img/demos/mi1@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo2.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi2@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo3.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi3@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo4.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi4@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo5.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi5@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo6.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi6@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo7.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi7@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo8.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi8@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo9.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi9@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo10.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi10@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo11.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi11@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo12.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi12@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo13.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi13@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo14.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi14@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo15.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi15@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo16.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi16@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo17.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi17@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo18.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi18@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo19.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi19@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo20.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi20@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo21.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi21@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo22.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi22@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo23.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi23@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo24.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi24@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo25.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi25@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo26.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi26@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo27.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi27@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo28.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi28@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo29.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi29@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo30.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi30@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo31.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi31@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo32.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi32@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo33.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi33@2x.jpg 2x" alt="image">
                                                        </figure>
                                                    ...
                                                    <a class="dropdown-item" href="./demo34.html">
                                                        <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                            <img class="!rounded-[.4rem]"
                                                                 ...
                                                                 srcset="@/assets/img/demos/mi34@2x.jpg 2x" alt="image">
                                                        </figure>
                                            ...
                                            <!--/.row -->
                                            <span class="hidden xl:!flex lg:!flex"><i
                                                class="uil uil-direction before:content-['\ea93']"></i><strong>Scroll to view more</strong></span>
                                        </li>
                                        <!--/.mega-menu-content-->
                                    </ul>
                                    <!--/.dropdown-menu -->
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown dropdown-submenu dropend"><a
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item"><a class="dropdown-item hover:!text-[#605dba]"
                                                                        href="./career-job.html">Job Description</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="dropdown dropdown-submenu dropend"><a
                                            ...
                                            <div>
                                                ...
                                                <ul class="pl-0 list-none">
                                                    <li><a class="dropdown-item hover:!text-[#605dba]"
                                                           href="./projects.html">Projects I</a></li>
                                                    <li><a class="dropdown-item hover:!text-[#605dba]"
                                                           href="./projects2.html">Projects II</a></li>
                                                    <li><a class="dropdown-item hover:!text-[#605dba]"
                                                           href="./projects3.html">Projects III</a></li>
                                                    <li><a class="dropdown-item hover:!text-[#605dba]"
                                                           href="./projects4.html">Projects IV</a></li>
                                                </ul>
                                            </div>
                                            <!-- /.column -->
                                            <div>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown dropdown-submenu dropend"><a
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a class="dropdown-item hover:!text-[#605dba]"
                                                                        href="./blog-post.html">Post without Sidebar</a>
                                                </li>
                                                <li class="nav-item"><a class="dropdown-item hover:!text-[#605dba]"
                                                                        href="./blog-post2.html">Post with Sidebar</a>
                                                </li>
                                                <li class="nav-item"><a class="dropdown-item hover:!text-[#605dba]"
                                                                        href="./blog-post3.html">Post with Left
                                                    Sidebar</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="dropdown-menu mega-menu mega-menu-dark mega-menu-img">
                                        <li class="mega-menu-content">
                                            <ul class="grid grid-cols-1 xl:grid-cols-6 lg:grid-cols-6 mx-0 xl:mx-[-15px] lg:mx-[-15px] xl:!mt-[-20px] lg:!mt-[-20px] !pl-0 list-none">
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/about.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block1.svg"
                                                             alt="image"></div>
                                                    <span>About</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/blog.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block2.svg"
                                                             alt="image"></div>
                                                    <span>Blog</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/call-to-action.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block3.svg"
                                                             alt="image"></div>
                                                    <span>Call to Action</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/clients.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block4.svg"
                                                             alt="image"></div>
                                                    <span>Clients</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/contact.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block5.svg"
                                                             alt="image"></div>
                                                    <span>Contact</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/facts.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block6.svg"
                                                             alt="image"></div>
                                                    <span>Facts</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/faq.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block7.svg"
                                                             alt="image"></div>
                                                    <span>FAQ</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/features.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block8.svg"
                                                             alt="image"></div>
                                                    <span>Features</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/footer.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block9.svg"
                                                             alt="image"></div>
                                                    <span>Footer</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/hero.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block10.svg"
                                                             alt="image"></div>
                                                    <span>Hero</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/misc.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block17.svg"
                                                             alt="image"></div>
                                                    <span>Misc</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/navbar.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block11.svg"
                                                             alt="image"></div>
                                                    <span>Navbar</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/portfolio.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block12.svg"
                                                             alt="image"></div>
                                                    <span>Portfolio</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/pricing.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block13.svg"
                                                             alt="image"></div>
                                                    <span>Pricing</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/process.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block14.svg"
                                                             alt="image"></div>
                                                    <span>Process</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/team.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block15.svg"
                                                             alt="image"></div>
                                                    <span>Team</span>
                                                </a>
                                                </li>
                                                <li class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"><a
                                                    class="dropdown-item" href="./docs/blocks/testimonials.html">
                                                    <div
                                                        class="rounded img-svg hidden xl:block lg:block p-4 xl:!mb-2 lg:!mb-2">
                                                        <img class="rounded-none" src="@/assets/img/demos/block16.svg"
                                                             alt="image"></div>
                                                ...
                                                <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] max-w-full">
                                                    ...
                                                    <ul class="pl-0 list-none  xl:columns-2 lg:columns-2  xl:pb-1 lg:pb-1">
                                                        <li class="xl:inline-block xl:w-full lg:inline-block lg:w-full">
                                                            <a class="dropdown-item hover:!text-[#605dba]"
                                                    ...
                                                    <h6 class="dropdown-header !text-[#605dba] xl:!mt-6 lg:!mt-6">
                                                        Styleguide</h6>
        ...
        <section class="wrapper overflow-hidden">
            <div class="container pt-36 xl:pt-[12.5rem] lg:pt-[12.5rem] md:pt-[12.5rem] !text-center !relative">
                <div class="absolute" style="top: -15%; left: 50%; transform: translateX(-50%);" data-cue="fadeIn"><img
                    class="!rounded-[0.8rem]" src="@/assets/img/photos/blurry.png" alt="image"></div>
                <div class="flex flex-wrap mx-[-15px] !relative">
                    <div
                        class="lg:w-8/12 xl:w-8/12 xxl:w-7/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mx-auto !relative">
                        <div class="absolute shape grape w-5 hidden xl:block lg:block" style="top: -5%; left: -15%;"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 219.5 219.5"
                                 ...
                                 class="svg-inject icon-svg !w-full !h-full">
                                <path class="svg-fill"
                                      d="M219.5 219.5H0c0-58.19 23.14-114.06 64.29-155.21A219.561 219.561 0 01219.5 0v219.5z"></path>
                            </svg>
                        </div>
                        <div class="absolute shape violet !w-[2.5rem] hidden xl:block lg:block"
                             style="bottom: 30%; left: -20%;" data-cue="fadeIn" data-delay="1500">
                        ...
                        <div class="absolute shape yellow w-6 hidden xl:block lg:block"
                             style="bottom: 25%; right: -17%;" data-cue="fadeIn" data-delay="1500">
                        ...
                        <div class="flex justify-center" data-cues="slideInDown" data-delay="600">
                            <span><a
                                class="btn btn-lg btn-grape !text-white !bg-[#605dba] border-[#605dba] hover:text-white hover:bg-[#605dba] hover:!border-[#605dba]   active:text-white active:bg-[#605dba] active:border-[#605dba] disabled:text-white disabled:bg-[#605dba] disabled:border-[#605dba] !rounded-[0.8rem] mx-1">See Projects</a></span>
                            <span><a
                                class="btn btn-lg btn-fuchsia !text-white !bg-[#e668b3] border-[#e668b3] hover:text-white hover:bg-[#e668b3] hover:!border-[#e668b3]   active:text-white active:bg-[#e668b3] active:border-[#e668b3] disabled:text-white disabled:bg-[#e668b3] disabled:border-[#e668b3] !rounded-[0.8rem] mx-1">Contact Us</a></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-[4.5rem] xl:!py-24 lg:!py-24 md:!py-24">
                <div class="flex flex-wrap mx-[-15px] !text-center">
                    <div class="xl:w-10/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mx-auto">
                        <h2 class="!text-[.75rem] uppercase !text-[#3f78e0] !tracking-[0.02rem] !leading-[1.35] !mb-3">
                            Job Positions</h2>
                        <h3 class="!text-[calc(1.305rem_+_0.66vw)] font-bold xl:!text-[1.8rem] !leading-[1.3] !mb-10 xxl:!px-20">
                            We’re always searching for amazing people to join our team. Take a look at our current
                            openings.</h3>
                    </div>
                    <!-- /column -->
                </div>
                ...
                <div class="flex flex-wrap mx-[-15px] !mt-[-30px]">
                    <div class="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px]">
                        <a href="#" class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lift !h-full">
                            <div class="card-body p-5 flex flex-row">
                                <div>
                                    <span
                                        class=" flex items-center justify-center font-bold !leading-[1.7] !tracking-[-0.01rem] rounded-[100%] bg-[rgba(226,98,107)] opacity-100 !text-white !w-[3rem] !h-[3rem] text-[1rem] !mr-4">SD</span>
                                </div>
                                <div>
                    ...
                    <div class="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px]">
                        <a href="#" class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lift !h-full">
                            <div class="card-body p-5 flex flex-row">
                                <div>
                                    <span
                                        class=" flex items-center justify-center font-bold !leading-[1.7] !tracking-[-0.01rem] rounded-[100%] bg-[rgba(69,196,160)] opacity-100 !text-white !w-[3rem] !h-[3rem] text-[1rem] !mr-4">UX</span>
                                </div>
                                <div>
                                    <span class="badge bg-[#e4f1f6] !text-[#54a8c7] rounded py-1 !mb-2">Remote</span>
                                    <h4 class="!mb-1">UI/UX Designer</h4>
                                    <p class="!mb-0 !text-[#60697b]">Anywhere</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px]">
                        <a href="#" class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lift !h-full">
                            <div class="card-body p-5 flex flex-row">
                                <div>
                                    <span
                                        class=" flex items-center justify-center font-bold !leading-[1.7] !tracking-[-0.01rem] rounded-[100%] bg-[rgba(250,183,88)] opacity-100 !text-white !w-[3rem] !h-[3rem] text-[1rem] !mr-4">AN</span>
                                </div>
                                <div>
                                    <span class="badge bg-[#e0e9fa] !text-[#3f78e0] rounded py-1 !mb-2">Full Time</span>
                    ...
                    <div class="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px]">
                        <a href="#" class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lift !h-full">
                            <div class="card-body p-5 flex flex-row">
                                <div>
                                    <span
                                        class=" flex items-center justify-center font-bold !leading-[1.7] !tracking-[-0.01rem] rounded-[100%] bg-[rgba(116,126,209)] opacity-100 !text-white !w-[3rem] !h-[3rem] text-[1rem] !mr-4">FD</span>
                                </div>
                                <div>
                                    <span class="badge bg-[#f0eaf6] !text-[#a07cc5] rounded py-1 !mb-2">Part Time</span>
                                    <h4 class="!mb-1">Front End Developer</h4>
                                    <p class="!mb-0 !text-[#60697b]">Sydney, AU</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px]">
                        <a href="#" class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lift !h-full">
                            <div class="card-body p-5 flex flex-row">
                                <div>
                                    <span
                                        class=" flex items-center justify-center font-bold !leading-[1.7] !tracking-[-0.01rem] rounded-[100%] bg-[rgba(247,139,119)] opacity-100 !text-white !w-[3rem] !h-[3rem] text-[1rem] !mr-4">MD</span>
                                </div>
                                <div>
                                    <span class="badge bg-[#e0e9fa] !text-[#3f78e0] rounded py-1 !mb-2">Full Time</span>
                    ...
                    <div class="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px]">
                        <a href="#" class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lift !h-full">
                            <div class="card-body p-5 flex flex-row">
                                <div>
                                    <span
                                        class=" flex items-center justify-center font-bold !leading-[1.7] !tracking-[-0.01rem] rounded-[100%] !bg-[rgba(209,107,134)] !opacity-100 !text-white !w-[3rem] !h-[3rem] text-[1rem] !mr-4">ND</span>
                                </div>
                                <div>
                                    <span class="badge bg-[#e0e9fa] !text-[#3f78e0] rounded py-1 !mb-2">Full Time</span>
