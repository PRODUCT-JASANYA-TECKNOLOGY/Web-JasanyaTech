                        ...
                        <li class="nav-item dropdown dropdown-mega">
                            ...
                            <ul class="dropdown-menu mega-menu mega-menu-dark mega-menu-img">
                                <li class="mega-menu-content mega-menu-scroll">
                                    <ul
                                        class="grid grid-cols-1 xl:grid-cols-6 lg:grid-cols-6 mx-0 xl:mx-[-10px] lg:mx-[-10px] xl:!mt-[-10px] lg:!mt-[-10px] !pl-0 list-none">
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo1.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi1.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo2.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi2.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo3.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi3.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo4.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi4.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo5.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi5.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo6.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi6.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo7.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi7.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo8.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi8.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo9.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi9.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo10.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi10.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo11.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi11.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo12.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi12.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo13.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi13.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo14.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi14.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo15.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi15.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo16.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi16.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo17.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi17.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo18.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi18.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo19.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi19.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo20.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi20.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo21.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi21.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo22.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi22.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo23.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi23.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo24.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi24.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo25.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi25.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo26.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi26.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo27.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi27.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo28.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi28.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo29.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi29.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo30.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi30.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo31.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi31.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo32.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi32.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo33.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi33.jpg"
                                        ...
                                        <li class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]">
                                            <a class="dropdown-item" href="./demo34.html">
                                                <figure class="!rounded-[.4rem] lift hidden xl:block lg:block">
                                                    <img class="!rounded-[.4rem]" src="./assets/img/demos/mi34.jpg"
                                    ...
                                    <span class="hidden xl:!flex lg:!flex"><i
                                            class="uil uil-direction before:content-['\ea93']"></i><strong>Scroll
                                    ...
                                    <div class="flex flex-wrap mx-0 xl:mx-[-7.5px] lg:mx-[-7.5px]">
                                        <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] max-w-full">
                                            ...
                                            <ul class="pl-0 list-none  xl:columns-2 lg:columns-2  xl:pb-1 lg:pb-1">
                                                <li class="xl:inline-block xl:w-full lg:inline-block lg:w-full">
                                                    <a class="dropdown-item hover:!text-[#605dba]"
                                                        href="./docs/index.html">Get Started</a>
                                                </li>
                                                <li class="xl:inline-block xl:w-full lg:inline-block lg:w-full">
                                                    <a class="dropdown-item hover:!text-[#605dba]"
                                            ...
                                            <ul class="pl-0 list-none  xl:columns-2 lg:columns-2 ">
                                                ...
                                                <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full">
                                                    <a class="dropdown-item hover:!text-[#605dba]"
                                                        href="./docs/styleguide/fonts.html">Fonts</a>
                                                </li>
                                                <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full">
                                                    <a class="dropdown-item hover:!text-[#605dba]"
                                                ...
                                                <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full">
                                                    <a class="dropdown-item hover:!text-[#605dba]"
                                                        href="./docs/styleguide/misc.html">Misc</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!--/column -->
