...
<footer class="bg-gray-200 opacity-100">
    <div class="container pt-8 xl:pt-10 lg:pt-10 md:pt-10 pb-7">
        <div class="flex flex-wrap mx-[-15px] xl:mx-0 lg:mx-0 !mt-[-30px]">
            ...
            <!-- /column -->
            <div
                class="xl:w-3/12 lg:w-3/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!ml-[16.66666667%] lg:!ml-[16.66666667%] xl:px-0 lg:px-0 !mt-[30px]">
                <div class="widget">
                    <div class="flex flex-row">
                        <div>
                            <div
                                class="icon !text-[#605dba] xl:!text-[1.4rem] !text-[calc(1.265rem_+_0.18vw)] !mr-4 !mt-[-0.25rem]">
