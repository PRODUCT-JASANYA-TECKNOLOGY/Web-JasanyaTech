    ...
    <div class="container pt-6">
        ...
        <div
            ...
            <div
                ...
                <div
                    class="svg-bg svg-bg-lg bg-[rgba(255,255,255)] opacity-100 !rounded-[0.8rem] shadow-[rgba(30,34,40,0.02)_0_2px_1px,rgba(30,34,40,0.02)_0_4px_2px,rgba(30,34,40,0.02)_0_8px_4px,rgba(30,34,40,0.02)_0_16px_8px,rgba(30,34,40,0.03)_0_32px_16px] !mb-6">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"
                        data-inject-url="https://sandbox-tailwind-template.netlify.app/assets/img/icons/solid/pen-tool.svg"
                        class="svg-inject icon-svg solid-duo text-grape-fuchsia">
                        <g data-name="Layer 2">
                ...
                <h3>Web Design</h3>
                <p class="!mb-3">Etiam porta sem malesuada magna mollis euismod. Donec ullamcorper nulla non metus
                    auctor
                    fringilla.</p>
            ...
            <div
                ...
                <div
                    class="svg-bg svg-bg-lg bg-[rgba(255,255,255)] opacity-100 !rounded-[0.8rem] shadow-[rgba(30,34,40,0.02)_0_2px_1px,rgba(30,34,40,0.02)_0_4px_2px,rgba(30,34,40,0.02)_0_8px_4px,rgba(30,34,40,0.02)_0_16px_8px,rgba(30,34,40,0.03)_0_32px_16px] !mb-6">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"
                        data-inject-url="https://sandbox-tailwind-template.netlify.app/assets/img/icons/solid/seo-2.svg"
                        class="svg-inject icon-svg solid-duo text-grape-fuchsia">
                        <path class="fill-primary"
                        ...
                        <circle class="fill-secondary" cx="128" cy="154.67" r="32"></circle>
                        <path class="fill-secondary"
            ...
            <div
                ...
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256.03 256.03"
                        data-inject-url="https://sandbox-tailwind-template.netlify.app/assets/img/icons/solid/shopping-basket.svg"
                        class="svg-inject icon-svg solid-duo text-grape-fuchsia">
                        <path class="fill-primary"
